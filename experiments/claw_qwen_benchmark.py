...
DETAILED_DIR = os.environ.get("DETAILED_DIR", str(REPO_ROOT.parent / "benchmark_qwen_detailed"))
...
def main():
    ...
    parser = argparse.ArgumentParser(description="ComfyClaw Qwen benchmark / single-prompt runner")
    ...
    if args.prompt:
        ...
        log.info("=" * 70)
        log.info("ComfyClaw + Qwen Image 2512 — custom prompt")
    ...
    log.info("LLM: %s  Diffusion: Qwen Image 2512 (BF16)", LLM_MODEL)
